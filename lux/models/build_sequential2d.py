...
Args:
    ...
    num_output_blocks: int: How many of the last n blocks are for the output
...
Returns:
    model: A Sequential2D model of shape:
      Blocks                                Activations
    [[I      None   None   ...    None]    [None            } Input space
     [None   I      None   ...    None]     None            }
     [...    ...    I      ...    None]     None            } 
     [f      f      f      f      f   ]     F.relu          } Hidden space
     [f      f      f      f      f   ]     F.relu          }
     [f      f      f      f      f   ]     F.relu          }
     [...    ...    ...    ...    ... ]     ...             }
     [...    ...    ...    ...    ... ]     ...             } Output space
...
def build_sequential2d(
    ...
    activations = (
        ...
        [F.relu] * (len(sizes) - num_input_blocks - num_output_blocks) +
